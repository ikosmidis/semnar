...
```
`start` and `end` are parsed using the [**parsedate**](https:://cran.r-project.org/package=parsedate), which allows for great flexibilty in the format that dates/times are supplied.
